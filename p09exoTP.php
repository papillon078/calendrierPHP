        ...
        <div class="container">
            ...
            <div class="answerZone mt-3">
                <form action="" class="d-inline" method="get" class="border border-white">
                    <!-- boucle pour générer la liste des années de 1970 à 2050 -->
                    <select name="year">
                ...
                <div class="row">
                    <div class="col-8 mb-5 mx-auto">
                        <table> 
                            ...
                            <tbody>
                                <?php
                                // condition pour afficher le mois en cours, si on a pas choisis dans la liste deroulante
                                if (!isset($_GET['month'])) { 
                                    $month = date('n'); 
                                } else { 
                                    $month = $_GET['month'];
                                ...
                                for ($j = 1; $j <= 6; $j++) {
                                    ...
                                    <tr>
                                        ...
                                        for ($i = 1; $i <= 7; $i++) {
                                            ...
                                            //condition pour commencer le compte à la bonne colonne et verifier à chaque colonne si on est dans une case grise ou pas
